...
sed -i '/rename/i \ \ curl -L https://github.com/llvm/llvm-project/commit/f800c1f3b207e7bcdc8b4c7192928d9a078242a0.patch -o llvm.patch' llvm/PKGBUILD 
sed -i '/rename/i \ \ ln -s llvm-$pkgver.src llvm' llvm/PKGBUILD
sed -i '/rename/i \ \ patch -Np1 -i llvm.patch' llvm/PKGBUILD
